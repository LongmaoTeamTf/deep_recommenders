...
if __name__ == "__main__":
    ...
    query_data = {
        ...
        'seed_tags': np.array([['催泪, 温情, 浪漫, 记录精选'], ['混剪, 跟着开眼看世界, 集锦, 风光大片, 星空, 极光, 摄影艺术, 旅游'], ['搞笑, 动画梦工厂, 魔性, 童趣, 喜剧, 无厘头, 讽刺, 幽默, 动画']]), 
